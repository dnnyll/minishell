...
static void print_commands(t_command *cmd)
{
    ...
    while (cmd)
    {
        ...
        // Print redirections
        printf("redir_in:\n");
        print_redirs(cmd->redir_in);
        printf("redir_out:\n");
        print_redirs(cmd->redir_out);

        // Print infile/outfile strings
...
// static void    debug_environment_variables_printer(t_data *data)
// {
//     int i;
...
static void    print_heredoc(t_command *command)
{
...
void print_redirs(t_redir *redir)
{
    ...
    while (redir)
    {
        printf("  filename: %s | append: %s\n", redir->filename,
               redir->append ? "true" : "false");
        redir = redir->next;
    }
}

// static void print_data_debug(t_data *data)
// {
